...
set_temperature(-20)
time.sleep(60*40)
temperature_setpoint_time(-10,10*magnitude)
temperature_setpoint_time(0,10*magnitude)
temperature_setpoint_time(10,10*magnitude)
temperature_setpoint_time(20,10*magnitude)
temperature_setpoint_time(30,10*magnitude)
temperature_setpoint_time(40,10*magnitude)
temperature_setpoint_time(50,10*magnitude)
